  ...
  it('passes custom params for livenessVerify', async () => {
    ...
    mockLivenessVerify.mockImplementation(
      (
        ...
        expect(showResultTips).toBe(true);
        callback({code: 10, msg: 'done', liveness: 0.98});
      },
    );
